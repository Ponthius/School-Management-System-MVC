...
{
    /// <inheritdoc />
    public partial class AddAttendanceExamsResults : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarkedByName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_Teachers_MarkedByTeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherComments = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    RecordedByName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamResults_ExamTerms_ExamTermId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExamSchedules_Teachers_InvigilatorTeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResults_ExamTermId_StudentId_SubjectId",
                table: "ExamResults",
                columns: new[] { "ExamTermId", "StudentId", "SubjectId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamSchedules_ExamTermId",
                table: "ExamSchedules",
                column: "ExamTermId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamSchedules_InvigilatorTeacherId",
                table: "ExamSchedules",
